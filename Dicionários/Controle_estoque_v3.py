# Nessa versão, o estoque está vazio, e o número de código de produto será gerado sequencialmente, sem a intervenção do usuário.
# Pontos para corrigir: 
#   [1] valor da mercadoria deve ser no formato 00.00; 
#   [2] atualização do estoque deve ser automática, levando em conta as inclusões e remoções de produtos. 
#   [3] Dessa forma, a opção 2 deve ser substituída por outra. 
#   [4] Programa pode começar com o estoque vazio, mas a partir do momento em que o primeiro produto for inserido, ele deve manter essa informação.
