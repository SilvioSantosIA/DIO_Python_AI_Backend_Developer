#1 Definindo em dicionário para o controle de estoque
estoque = {
    '001' : {'nome': 'Camiseta', 'preco': 29.90, 'quantidade': 100},
    '002' : {'nome': 'Calça Jeans', 'preco': 79.90, 'quantidade': 50.00},
...
def adicionar_produto():
    ...
    nome = input("Digite o nome de novo produto: ")
...
#4 Função para remover um produto de estoque
...
while True:
    ...
    if opcao == '1':
        ...
        print("\n============== Produtos no Estoque ===============")
        for codigo, produto in estoque.produto():
